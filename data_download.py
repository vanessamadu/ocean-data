...
options = ['short_geostrophic_velocities','short_wind','long_geostrophic_velocities']
toggle = options[1]
...
if toggle == 'short_geostrophic_velocities':
    ...
    # LONGER TIME FRAME 01/01/1993 - 08/09/2023
    dataset_id = "cmems_obs-sl_glo_phy-ssh_my[int]_allsat-l4-duacs-0.25deg_P1D"
    variables = ["ugos","vgos","ugosa", "vgosa","err_ugosa","err_vgosa"]
    # West NA
    min_lon, max_lon = -83, -40 
    min_lat, max_lat = 0, 60
    start_date, end_date = "1993-01-01 00:00:00", "2023-09-08 23:00:00"
    min_depth, max_depth = 0, 15
    output_filename = "CMEMS_West_NA_currents_1993_2023.nc"
...
# LONGER TIME FRAME 01/01/1993 - 08/09/2023
    ...
    min_lon, max_lon = -83, -40 
    min_lat, max_lat = 0, 60
    start_date, end_date = "1994-06-01 00:00:00", "2023-09-08 23:00:00"
    output_filename = "Full_CMEMS_West_NA_wind_1994_2023.nc"
    timestamps = generate_daily_timestamps(start_date, end_date)
    ...
    # LONGER TIME FRAME 01/01/1993 - 08/09/2023
    dataset_id = "SST-GLO-SST-L4-REP-OBSERVATIONS-010-011"
    variables = ["analysed_sst","analysis_error"]
    # West NA
    min_lon, max_lon = -83, -40 
    min_lat, max_lat = 0, 60
    start_date, end_date = "1993-01-01 00:00:00", "2022-05-31 23:00:00"
    output_filename = "CMEMS_West_NA_sst_1993_2022.nc"
